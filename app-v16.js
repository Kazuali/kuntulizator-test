...
function initAdminChat() {
  ...
  let replyIndex = Number(localStorage.getItem("kuntulizatorAdminReplyIndex") || "0") || 0;
  ...
  form.addEventListener("submit", (event) => {
    ...
    typingTimer = window.setTimeout(() => {
      ...
      replyIndex += 1;
      localStorage.setItem("kuntulizatorAdminReplyIndex", String(replyIndex));
    }, 1050);
  });
}
