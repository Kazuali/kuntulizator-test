...
/* v18 — фейковый чат админа: телевизор */
function initAdminChat() {
  ...
  let replyIndex = Number(localStorage.getItem("kuntulizatorAdminReplyIndexV18") || "0") || 0;
  ...
  form.addEventListener("submit", (event) => {
    ...
    typingTimer = window.setTimeout(() => {
      ...
      replyIndex += 1;
      localStorage.setItem("kuntulizatorAdminReplyIndexV18", String(replyIndex));
    }, 1050);
  });
}
