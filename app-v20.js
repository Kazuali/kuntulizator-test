...
/* v20 — фейковый чат админа: телевизор, фикс мобильной клавиатуры */
function initAdminChat() {
  ...
  let replyIndex = Number(localStorage.getItem("kuntulizatorAdminReplyIndexV20") || "0") || 0;
  ...
  form.addEventListener("submit", (event) => {
    ...
    typingTimer = window.setTimeout(() => {
      ...
      replyIndex += 1;
      localStorage.setItem("kuntulizatorAdminReplyIndexV20", String(replyIndex));
    }, 1050);
  });
}
